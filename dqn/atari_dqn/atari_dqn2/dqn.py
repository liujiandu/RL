...
class DQN(object):
    def __init__(self,env,
        ...
        self.qvals = policy.policy_net(self.state, self.nact, "qnet", reuse=False)
        ...
        self.target_qvals = policy.policy_net(self.state, self.nact, "qtarget_net", reuse=False)
    ...
    def update_target(self):
        for var, target_var in zip(self.vars, self.target_vars):
            self.sess.run(tf.assign(target_var, (1.0-self.tau)*target_var+ self.tau*var))
